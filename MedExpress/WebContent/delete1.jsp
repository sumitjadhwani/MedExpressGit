    ...
    <div class="row content">
      <div class="col-sm-3 sidenav hidden-xs">
        ...
        <ul class="nav nav-pills nav-stacked">
          ...
          <li class="active"><a href="delete1.jsp">Delete Drugs</a></li>
...
<div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Delete Drug</h6>
                  </div>
                  <div class="card-body">                           
...
<td><a href="delete.jsp?id=<%=resultSet.getString("drug_id")%>">Delete</a></td>
</tr>
<%
}
connection.close();
